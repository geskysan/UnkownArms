...
#define WINDOW_NAME		"UnknownArms"		// ウインドウのキャプション名
...
void Update(void)
{
	...
	case MODE_GAMEMAIN:
		...
		if (GetKeyboardPress(DIK_NUMPAD1) == true && GetFade() == FADE_NONE)
			SetFade(MODE_TITLE);
	
		if (GetKeyboardPress(DIK_NUMPAD2) == true && GetFade() == FADE_NONE)
